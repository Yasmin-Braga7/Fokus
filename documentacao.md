...
2. npm run reset-project -> Reseta um projeto para ficar limpo
...
<View></View> -> Funciona como container "div". É obrigatórip para outros componentes. É por padrão flex.
<Text></Text> -> Funciona quando você vai utilizar textos.
<Image> -> Utilizado para renderizar imagem no projeto.
<Pressable></Pressable> -> Utilizado quando temos algo pressionável.

## FUNÇÕES UTILIZADAS NO REACT NATIVE]
